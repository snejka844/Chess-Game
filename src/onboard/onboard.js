        ...
        return (<React.Fragment>
            ...
            :
               <div>
                    ...
                    <input style={{marginLeft: String((window.innerWidth / 2) - 690) + "px", width: "240px", marginTop: "62px"}} 
                           ref = {this.textArea}
                           onInput = {this.typingUserName}></input>
                           
                    <button className="btn btn-primary" 
                        style = {{marginLeft: String((window.innerWidth / 2) - 630) + "px", width: "120px", marginTop: "62px"}} 
